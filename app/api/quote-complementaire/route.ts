...
<p style="margin-top:18px">Cordialement,<br><strong>${tn}</strong><br>Les Techniciens du Débouchage</p>
</td></tr>
...
<p style="font-size:13px;color:#64748b">Merci,<br><strong>${tn}</strong> — Les Techniciens du Débouchage</p>
</div></body></html>`
}
