...
export const BRAND = {
  ...
  zone: "Tout le Var (83)",
  logoUrl: "https://lestechniciensdudebouchage.fr/icons/icon-1024x1024.png",
  logoSmallUrl: "https://lestechniciensdudebouchage.fr/icons/icon-512x512.png",
  camionUrl:
    "https://lestechniciensdudebouchage.fr/images/le-plombier-deboucheur-des-techniciens-du-debouchage.webp",
