...
4. LTDB_PUBLISH_TOKEN from Django backend
...
LTDB_API_URL=https://lestechniciensdudebouchage.fr
LTDB_PUBLISH_TOKEN=ruiQvAxSn5VL075j9WfTEL7ftvykTXkEgqBvbfFQfsw
```
...
npx vercel env add LTDB_API_URL production
# Paste: https://lestechniciensdudebouchage.fr

npx vercel env add LTDB_PUBLISH_TOKEN production
...
1. Open the Vercel URL (e.g., https://app-realisations-ltdb.vercel.app)
...
### LTDB API not responding
- Verify LTDB_PUBLISH_TOKEN matches Django settings
- Check LTDB_API_URL is accessible from Vercel region
