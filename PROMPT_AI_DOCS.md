...
1. Un rapport d'intervention (PDF + page de réalisation SEO publiée sur lestechniciensdudebouchage.fr).
...
4. **Site web :** `https://lestechniciensdudebouchage.fr` (constante `SITE` dans `generate/route.ts`).
