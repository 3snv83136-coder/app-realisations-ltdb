...
- [ ] If LTDB is accessible:
  ...
  - URL should point to lestechniciensdudebouchage.fr
...
- [ ] For LTDB publish: verify LTDB_PUBLISH_TOKEN matches Django config

### LTDB Integration Issues
- [ ] Verify LTDB_API_URL is accessible: curl https://lestechniciensdudebouchage.fr
- [ ] Check Django backend is running
- [ ] Verify LTDB_PUBLISH_TOKEN matches exactly (check for spaces/typos)
